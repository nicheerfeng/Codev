    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <SectionHeader
          ...
          description={translate("View and customize keyboard shortcuts.")}
        />
        <Button
          variant="outline"
          size="sm"
      ...
      <div className="relative">
        ...
        />
        <Input
          placeholder={translate("Search shortcuts...")}
          value={search}
      ...
      <AlertDialog open={resetDialogOpen} onOpenChange={setResetDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{translate("Reset all shortcuts?")}</AlertDialogTitle>
            <AlertDialogDescription>
              {translate(
  ...
  return (
    <div className="group flex items-center justify-between px-3 py-2.5 transition-colors hover:bg-muted/30">
      <div className="flex flex-col gap-0.5">
        <span className="text-[12.5px] font-medium">{translate(shortcut.label)}</span>
      </div>
          ...
          <>
            ...
            <div className="flex items-center gap-1">
              ...
              <Button
                ...
                onClick={onClear}
                title={translate("Clear shortcut")}
              >
...
function Recorder({
  ...
  return (
    <div className="flex items-center gap-2 rounded bg-accent/50 px-2 py-1 text-[11px] ring-1 ring-accent">
      <span className="animate-pulse font-medium">{translate("Recording...")}</span>
      <span className="text-muted-foreground">{translate("(Esc to cancel)")}</span>
    </div>
  );
}
