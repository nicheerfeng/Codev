  ...
  return (
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            {translate("Install")} {server.name} {translate("language server")}
          </DialogTitle>
          <DialogDescription>
            {translate("Terax could not find")} {" "}
            <code className="font-mono text-foreground">{server.command}</code>{" "}
            {translate(
              "on your PATH. Install it, then check again to enable this language server.",
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="items-center sm:justify-between">
          ...
          >
            ...
            />
            {checking ? translate("Checking...") : translate("Check again")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
